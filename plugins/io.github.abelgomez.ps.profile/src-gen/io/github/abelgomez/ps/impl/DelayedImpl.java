 ...
 * </p>
 * <ul>
 *   <li>{@link io.github.abelgomez.ps.impl.DelayedImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link io.github.abelgomez.ps.impl.DelayedImpl#getBase_Message <em>Base Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DelayedImpl extends MinimalEObjectImpl.Container implements Delayed {
	...
	protected EClass eStaticClass() {
		return PsPackage.Literals.DELAYED;
	}
	...
	public void setDelay(int newDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PsPackage.DELAYED__DELAY, oldDelay, delay));
	}
	...
	public Message getBase_Message() {
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PsPackage.DELAYED__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PsPackage.DELAYED__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PsPackage.DELAYED__DELAY:
				return getDelay();
			case PsPackage.DELAYED__BASE_MESSAGE:
