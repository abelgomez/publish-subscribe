 ...
 * </p>
 * <ul>
 *   <li>{@link io.github.abelgomez.cpntools.impl.UnitImpl#getWith <em>With</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitImpl extends SimpleColorSetImpl implements Unit {
	/**
	...
	protected EClass eStaticClass() {
		return CpntoolsPackage.Literals.UNIT;
	}
	...
	public void setWith(String newWith) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpntoolsPackage.UNIT__WITH, oldWith, with));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CpntoolsPackage.UNIT__WITH:
				return getWith();
		}
