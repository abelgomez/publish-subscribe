 ...
 * </p>
 * <ul>
 *   <li>{@link io.github.abelgomez.cpntools.impl.PortImpl#getPortType <em>Port Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PortImpl extends DiagramElementImpl implements Port {
	/**
	...
	protected EClass eStaticClass() {
		return CpntoolsPackage.Literals.PORT;
	}
	...
	public void setPortType(String newPortType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpntoolsPackage.PORT__PORT_TYPE, oldPortType, portType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CpntoolsPackage.PORT__PORT_TYPE:
				return getPortType();
		}
